                    ...
                    <ul class="address-item-list clear js-address-item-list">
                        ...
                        >
                            ...
                            <div class="operation-section">
                                <span @click="popShow(index)" class="update-btn js-edit-address">修改</span>
                                <span class="delete-btn js-delete-address">删除</span>
                            </div>
                        </li>
                        <li @click="popShow(-1)" class="add-address-item js-add-address">
                            <p>使用新地址</p>
                        </li>
                    </ul>
                </div>
