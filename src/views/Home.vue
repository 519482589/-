...
export default {
    data() {
        return {
            goodlist:[],
            words:`<div contenteditable="true" style="width:100%; height:100%;" class="w-e-text" id="text-elem07491764873854789"><p><span style="background-color: rgb(249, 150, 59);">欢迎使用<b style="">wangEditor 富文本编辑器</b>，请输入内容...</span></p><p><span style="background-color: rgb(249, 150, 59);"><br></span></p><h1><span style="background-color: rgb(255, 255, 255);">我是标题</span></h1><p><br></p></div>`
        }
    },
    components:{
        GoodItem
